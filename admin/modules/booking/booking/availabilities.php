...
// 年月日 Y/m/d
$from_date = gmdate('Y/m/d', $from_time);
$to_date = gmdate('Y/m/d', $to_time);
                                    ...
                                    <div class="col-md-12 form-inline">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control datepicker" id="from_picker" rel="to_picker" name="from_date" value="<?php echo $from_date; ?>" readonly="readonly" onkeydown="return false">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control datepicker" id="to_picker" rel="from_picker" name="to_date" value="<?php echo $to_date; ?>" readonly="readonly" onkeydown="return false">
                                            </div>
                                            <div class="field-notice" rel="to_date"></div>
                                        </div>
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-default" name="change_date">找尋</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                                            ...
                                            foreach($rooms as $room_id => $row){ ?>
                                                ...
                                                for($n = 0; $n <= $row['n']; $n++){ ?>
                                                    <div class="room-label">
                                                        <span id="room-num-<?php echo $room_id; ?>-<?php echo $n; ?>"><?php echo ' #No.'.($n+1); ?></span>
